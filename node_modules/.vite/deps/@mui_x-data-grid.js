...
} from "./chunk-3QS3KW23.js";
import "./chunk-U53PFHE4.js";
import "./chunk-5ODYER7P.js";
import "./chunk-HWI6CBPC.js";
import "./chunk-XBGG2GWE.js";
import {
  useOnMount
} from "./chunk-A6D3LBQJ.js";
import "./chunk-2O3S46ZT.js";
import "./chunk-XO4OSLMW.js";
import "./chunk-4XNDQLWR.js";
import "./chunk-JPTDGG5L.js";
import "./chunk-MDIIU4PO.js";
import "./chunk-D7UFHGQQ.js";
import {
  useTheme
} from "./chunk-OPFNE6J7.js";
import "./chunk-H2WQT6UF.js";
import "./chunk-64FVIM6J.js";
import {
  getThemeProps,
  require_prop_types
} from "./chunk-4SBBQL2M.js";
import "./chunk-4SH6T4MF.js";
...
import {
  _extends
} from "./chunk-4JHPVDTR.js";
import "./chunk-XU54WOJK.js";
import "./chunk-6BK2HIFJ.js";
import {
  require_react
...
var useGridApiRef = () => React.useRef(null);

// node_modules/@mui/x-data-grid/esm/DataGrid/index.js
import "D:/react-dashboard-crm/node_modules/@mui/x-data-grid/esm/index.css";
...
function GridContextProvider({
  ...
  return (0, import_jsx_runtime.jsx)(GridConfigurationContext.Provider, {
    value: configuration2,
    children: (0, import_jsx_runtime.jsx)(GridRootPropsContext.Provider, {
      value: props,
      children: (0, import_jsx_runtime.jsx)(GridPrivateApiContext.Provider, {
        ...
        children: (0, import_jsx_runtime.jsx)(GridApiContext.Provider, {
          value: apiRef,
          children: (0, import_jsx_runtime.jsx)(GridPanelContextProvider, {
            children: (0, import_jsx_runtime.jsx)(GridCSSVariablesContext, {
              children
            })
          })
        })
...
var useDataGridComponent = (apiRef, props, configuration2) => {
  ...
  useGridParamsApi(apiRef, props, configuration2);
  useGridColumnSpanning(apiRef);
  useGridColumnGrouping(apiRef, props);
  useGridEditing(apiRef, props, configuration2);
...
var useDataGridProps = (inProps) => {
  ...
  const themedProps = React5.useMemo(() => getThemeProps({
    props: inProps,
    theme,
    name: "MuiDataGrid"
  }), [theme, inProps]);
  const localeText = React5.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React5.useMemo(() => computeSlots({
    defaultSlots,
    slots: themedProps.slots
  }), [themedProps.slots]);
  const injectDefaultProps = React5.useMemo(() => {
    return Object.keys(DATA_GRID_PROPS_DEFAULT_VALUES).reduce((acc, key) => {
      acc[key] = themedProps[key] ?? DATA_GRID_PROPS_DEFAULT_VALUES[key];
      return acc;
    }, {});
  }, [themedProps]);
  return React5.useMemo(() => _extends({}, themedProps, injectDefaultProps, {
    localeText,
    slots
...
var DataGridRaw = function DataGrid(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(GridContextProvider, {
    ...
    configuration,
    props,
    children: (0, import_jsx_runtime2.jsx)(MemoizedGridRoot, _extends({
...
var DataGrid2 = React6.memo(forwardRef(DataGridRaw));
