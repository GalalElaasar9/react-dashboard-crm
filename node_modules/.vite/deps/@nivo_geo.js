...
function rotationPhiGamma(deltaPhi, deltaGamma) {
  ...
  function rotation(lambda, phi) {
    var cosPhi = cos(phi), x = cos(lambda) * cosPhi, y = sin(lambda) * cosPhi, z3 = sin(phi), k = z3 * cosDeltaPhi + x * sinDeltaPhi;
    return [
      atan2(y * cosDeltaGamma - k * sinDeltaGamma, x * cosDeltaPhi - z3 * sinDeltaPhi),
      asin(k * cosDeltaGamma + y * sinDeltaGamma)
    ];
  }
  rotation.invert = function(lambda, phi) {
    var cosPhi = cos(phi), x = cos(lambda) * cosPhi, y = sin(lambda) * cosPhi, z3 = sin(phi), k = z3 * cosDeltaGamma - y * sinDeltaGamma;
    return [
      atan2(y * cosDeltaGamma + z3 * sinDeltaGamma, x * cosDeltaPhi + k * sinDeltaPhi),
...
function circle_default(radius) {
  ...
  function intersect(a, b, two) {
    ...
    q2 = spherical(q2);
    if (!two) return q2;
    var lambda02 = a[0], lambda1 = b[0], phi0 = a[1], phi1 = b[1], z3;
    if (lambda1 < lambda02) z3 = lambda02, lambda02 = lambda1, lambda1 = z3;
...
function lengthPoint(lambda, phi) {
  lambda *= radians, phi *= radians;
  var sinPhi = sin(phi), cosPhi = cos(phi), delta = abs(lambda - lambda0), cosDelta = cos(delta), sinDelta = sin(delta), x = cosPhi * sinDelta, y = cosPhi0 * sinPhi - sinPhi0 * cosPhi * cosDelta, z3 = sinPhi0 * sinPhi + cosPhi0 * cosPhi * cosDelta;
  lengthSum.add(atan2(sqrt(x * x + y * y), z3));
...
function centroidPointLine(x, y) {
  var dx = x - x03, dy = y - y03, z3 = sqrt(dx * dx + dy * dy);
  X1 += z3 * (x03 + x) / 2;
  Y1 += z3 * (y03 + y) / 2;
  Z1 += z3;
  centroidPoint(x03 = x, y03 = y);
...
function azimuthalInvert(angle) {
  return function(x, y) {
    var z3 = sqrt(x * x + y * y), c = angle(z3), sc = sin(c), cc = cos(c);
    return [
      atan2(x * sc, z3 * cc),
      asin(z3 && y * sc / z3)
    ];
...
function equalEarthRaw(lambda, phi) {
  ...
  return [
    lambda * cos(l) / (M2 * (A1 + 3 * A2 * l2 + l6 * (7 * A3 + 9 * A4 * l2))),
...
equalEarthRaw.invert = function(x, y) {
  ...
  return [
    M2 * x * (A1 + 3 * A2 * l2 + l6 * (7 * A3 + 9 * A4 * l2)) / cos(l),
    asin(sin(l) / M2)
  ];
};
...
var z2 = function(o2) {
  var t2 = o2.width, r2 = o2.height, i2 = o2.projectionType, n2 = o2.projectionScale, a = o2.projectionTranslation, l = o2.projectionRotation, u = o2.fillColor, d = o2.borderWidth, c = o2.borderColor, f = a[0], h = a[1], s = l[0], g = l[1], p2 = l[2], m2 = (0, import_react.useMemo)((function() {
    ...
    return graticule();
  }), []), j = M(), w = (0, import_react.useMemo)((function() {
...
var V = Gt((0, import_react.memo)((function(o2) {
  var e3 = o2.width, i2 = o2.height, n2 = o2.margin, a = o2.features, d = o2.layers, c = void 0 === d ? ["graticule", "features"] : d, f = o2.projectionType, h = void 0 === f ? "mercator" : f, g = o2.projectionScale, m2 = void 0 === g ? 100 : g, C2 = o2.projectionTranslation, b = void 0 === C2 ? [0.5, 0.5] : C2, j = o2.projectionRotation, w = void 0 === j ? [0, 0, 0] : j, W = o2.fillColor, y = void 0 === W ? "#dddddd" : W, M3 = o2.borderWidth, k = void 0 === M3 ? 0 : M3, T2 = o2.borderColor, F = void 0 === T2 ? "#000000" : T2, S = o2.enableGraticule, E2 = void 0 !== S && S, L2 = o2.graticuleLineWidth, R = void 0 === L2 ? 0.5 : L2, B = o2.graticuleLineColor, x = void 0 === B ? "#999999" : B, P2 = o2.isInteractive, G = void 0 === P2 || P2, H = o2.onClick, D2 = void 0 === H ? function() {
  } : H, O2 = o2.tooltip, K2 = o2.role, V2 = void 0 === K2 ? "img" : K2, A5 = cn(e3, i2, n2), J2 = A5.margin, N2 = A5.outerWidth, Q2 = A5.outerHeight, U2 = z2({ width: e3, height: i2, projectionType: h, projectionScale: m2, projectionTranslation: b, projectionRotation: w, fillColor: y, borderWidth: k, borderColor: F }), X3 = U2.graticule, Y3 = U2.path, Z3 = U2.getFillColor, $2 = U2.getBorderWidth, _2 = U2.getBorderColor, oo2 = M(), eo2 = z(), to2 = eo2.showTooltipFromEvent, ro2 = eo2.hideTooltip, io2 = (0, import_react.useCallback)((function(o3, e4) {
...
var N = Gt((0, import_react.memo)((function(o2) {
  ...
  var ro2 = z(), io2 = ro2.showTooltipFromEvent, no2 = ro2.hideTooltip, ao = (0, import_react.useCallback)((function(o3) {
    if (H && K2) {
...
var $ = Gt((0, import_react.memo)((function(o2) {
  ...
  var To = z(), Fo = To.showTooltipFromEvent, So = To.hideTooltip, Eo = (0, import_react.useCallback)((function(o3) {
    if (to2 && uo) {
