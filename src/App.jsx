  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "/bar", element: <ProtectedRoute><Bar/></ProtectedRoute> },
        { path: "/line", element: <ProtectedRoute><Line/></ProtectedRoute> },
        { path: "/pie", element: <ProtectedRoute><Pie/></ProtectedRoute> },
        { path: "/geography", element: <ProtectedRoute><Geography/></ProtectedRoute> },
      ],
    },
  ]);
